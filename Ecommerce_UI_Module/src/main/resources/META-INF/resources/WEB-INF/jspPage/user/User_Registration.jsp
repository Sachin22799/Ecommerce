...
body {
background-image: url("static/img/banner/banner.jpg");
			...
			method="post"
				...
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<input id="mobile" name="contactNo" placeholder="Insert your Mobile"
								class="form-control input-md" required="required" type="number"
								onblur="validateMobile()"> <span class="help-block">Please
								enter a 10-digit mobile number.</span>
						</div>
